...
INSERT INTO cards (id, title) VALUES (2, 'かんばんボードを追加する');
INSERT INTO cards (id, title, description) VALUES (3, 'かんばんのデータをCoreプロセスと連携する', 'react-kanbanを使用する');
INSERT INTO cards (id, title, description) VALUES (4, 'かんばんのデータをSQLiteに保存する', 'SQLxクレートを保存する');
